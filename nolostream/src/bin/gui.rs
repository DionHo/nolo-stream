...
impl NoloApp {
    fn new(state: Arc<Mutex<AppState>>) -> Self {
        ...
        NoloApp {
            ...
            teleop_left_addr:      config.teleop_left_to.map_or("127.0.0.1:9001".into(), |a| a.to_string()),
            teleop_right_enabled:  config.teleop_right_to.is_some(),
            teleop_right_addr:     config.teleop_right_to.map_or("127.0.0.1:9002".into(), |a| a.to_string()),
